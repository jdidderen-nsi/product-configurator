...
class ProductConfigWebsiteSale(WebsiteSale):
    ...
    def get_render_vals(self, cfg_session):
        ...
        _logger.warning(check_val_ids)
        _logger.warning(check_val_ids.mapped('name'))
        _logger.warning(available_value_ids)
        _logger.warning(request.env["product.attribute.value"].sudo().browse(available_value_ids).mapped("name"))
        _logger.warning(cfg_session.value_ids)
        _logger.warning(cfg_session.value_ids.mapped('name'))
        vals = {
